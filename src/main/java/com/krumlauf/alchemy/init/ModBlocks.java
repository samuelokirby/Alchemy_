...
import com.krumlauf.alchemy.blocks.ManaRichOre;
...
import com.krumlauf.alchemy.items.food.BlockManaEssencePlant;
...
public class ModBlocks {
	...
	public static final Block MANA_RICH_ORE = new ManaRichOre("mana_rich_ore", Material.ROCK);
	
	//Crop Blocks
	public static final Block MANA_ESSENCE_PLANT = new BlockManaEssencePlant("mana_essence_plant");
}
